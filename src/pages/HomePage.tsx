      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="bg-blue-600 text-gray-800 font-semibold px-4 py-2 rounded-lg shadow hover:bg-blue-700 transition-colors"
          >
            Nhập dữ liệu protein
          </button>
          <button
            onClick={() => navigate("/result")}
            className="bg-green-600 text-gray-800 font-semibold px-4 py-2 rounded-lg shadow hover:bg-green-700 transition-colors"
          >
            Xem kết quả
          </button>
          <button
            onClick={() => navigate("/history")}
            className="bg-purple-600 text-gray-800 font-semibold px-4 py-2 rounded-lg shadow hover:bg-purple-700 transition-colors"
          >
            Lịch sử tra cứu
          </button>
        </div>
